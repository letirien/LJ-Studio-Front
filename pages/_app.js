...
function App({ Component, pageProps }) {
  ...
  return (
      <>
        <div
          aria-hidden="true"
          className="pointer-events-none fixed inset-x-0 top-0 z-[9999] block h-[12px] sm:hidden"
          style={{ backgroundColor: 'var(--browser-chrome-top-color, #000000)' }}
        />
        <div
          aria-hidden="true"
          className="pointer-events-none fixed inset-x-0 bottom-[-8px] z-[9999] block h-[12px] sm:hidden"
