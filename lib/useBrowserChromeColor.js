...
export function useBrowserChromeColor() {
  useEffect(() => {
    ...
    document.querySelectorAll('.browser-color-white, .browser-color-orange, .browser-color-black, [data-browser-color], section.white, section.orange, section.black, footer.white, footer.orange, footer.black, .browser-chrome-edge-overlay')
