...
const WEIGHTS = {
  ...
  // SCROLL_BEHAVIORS_READY: 5, // Animations scroll (Collab marquees, etc.)
};
...
export function LoadingProvider({ children }) {
  ...
  const calculateTotalProgress = useCallback((stages) => {
    const total =
      ...
      // (stages.scrollBehaviorsReady / 100) * WEIGHTS.SCROLL_BEHAVIORS_READY;
  ...
  // const setScrollBehaviorsReady = useCallback(() => {
  //   updateStage('scrollBehaviorsReady', 100);
  // }, [updateStage]);
