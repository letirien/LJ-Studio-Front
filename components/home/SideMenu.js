    ...
    <>
      ...
      >
        <div className="flex flex-col space-y-6 font-bold uppercase text-black my-auto">
          <a href="#services" className="text-[21vw] sm:text-[8vw] hover:text-white relative w-content hardbop-bold"><span className=''>SERVICES</span><span className='absolute text-200 mt-1 ml-2 text-[18pt]'>01</span></a>
          <a href="#work" className="hardbop-bold text-[72pt] sm:text-[8vw] hover:text-white">WORK<span className='absolute text-200 mt-1 ml-2 text-[21pt]'>02</span></a>
          <a href="#archive" className="hardbop-bold text-[21vw] sm:text-[8vw] hover:text-white">ARCHIVE<span className='absolute text-200 mt-1 ml-2 text-[21pt]'>03</span></a>
          <a href="#about" className="hardbop-bold text-[21vw] sm:text-[8vw] hover:text-white">ABOUT<span className='absolute text-200 mt-1 ml-2 text-[21pt]'>04</span></a>
          <a href="#contact" className="hardbop-bold text-[21vw] sm:text-[8vw] hover:text-white">CONTACT<span className='absolute text-200 mt-1 ml-2 text-[21pt]'>05</span></a>
        </div>
